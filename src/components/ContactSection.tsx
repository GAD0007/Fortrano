  ...
  return (
    <section id="contact" className="bg-[#0b0f1e] text-white">
      <div className="mx-auto max-w-[1390px] px-5 pb-24 pt-20 sm:px-8 lg:px-10 lg:pb-28 lg:pt-28">
       ...
       <h2 className="font-black uppercase leading-none tracking-[-0.02em] text-[clamp(1.75rem,4vw,2.75rem)] mx-auto max-w-[980px] bg-gradient-to-r from-[#ffffff] via-[#10b9e8] to-[#1e90ff] bg-clip-text text-transparent">Let's Make Magic<span className="block">Together</span></h2>
          <Link
            to="/contact"
